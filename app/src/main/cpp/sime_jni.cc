...
Java_ink_wenmo_ime_engine_SimeEngine_nativeLoadResources(
...
JNIEXPORT jboolean JNICALL
Java_ink_wenmo_ime_engine_SimeEngine_nativeIsReady(
    JNIEnv* /*env*/, jclass /*clazz*/) {
    return (g_sime && g_sime->Ready()) ? JNI_TRUE : JNI_FALSE;
}

JNIEXPORT jint JNICALL
Java_ink_wenmo_ime_engine_SimeEngine_nativeContextSize(
    JNIEnv* /*env*/, jclass /*clazz*/) {
    return (g_sime && g_sime->Ready()) ? g_sime->ContextSize() : 2;
}

JNIEXPORT void JNICALL
Java_ink_wenmo_ime_engine_SimeEngine_nativeResetCaches(
    JNIEnv* /*env*/, jclass /*clazz*/) {
    if (g_sime && g_sime->Ready()) g_sime->ResetCaches();
}

JNIEXPORT jint JNICALL
Java_ink_wenmo_ime_engine_SimeEngine_nativeDecodeSentence(
    JNIEnv* env, jclass /*clazz*/,
...
JNIEXPORT jint JNICALL
Java_ink_wenmo_ime_engine_SimeEngine_nativeDecodeNumSentence(
    JNIEnv* env, jclass /*clazz*/,
...
JNIEXPORT jint JNICALL
Java_ink_wenmo_ime_engine_SimeEngine_nativeNextTokens(
    JNIEnv* env, jclass /*clazz*/,
...
JNIEXPORT jint JNICALL
Java_ink_wenmo_ime_engine_SimeEngine_nativeGetTokens(
    JNIEnv* env, jclass /*clazz*/,
...
Java_ink_wenmo_ime_engine_SimeEngine_nativeT9PinyinSyllables(
    JNIEnv* env, jclass /*clazz*/,
...
Java_ink_wenmo_ime_engine_SimeEngine_nativeResultText(
...
JNIEXPORT jstring JNICALL
Java_ink_wenmo_ime_engine_SimeEngine_nativeResultUnits(
    JNIEnv* env, jclass /*clazz*/, jint index) {
    auto i = static_cast<std::size_t>(index);
    if (i >= g_results.size()) return env->NewStringUTF("");
...
JNIEXPORT jint JNICALL
Java_ink_wenmo_ime_engine_SimeEngine_nativeResultConsumed(
    JNIEnv* /*env*/, jclass /*clazz*/, jint index) {
    auto i = static_cast<std::size_t>(index);
...
Java_ink_wenmo_ime_engine_SimeEngine_nativeResultTokenIds(
    JNIEnv* env, jclass /*clazz*/, jint index) {
    auto i = static_cast<std::size_t>(index);
...
JNIEXPORT jboolean JNICALL
Java_ink_wenmo_ime_engine_SimeEngine_nativeLoadUserSentence(
...
JNIEXPORT jboolean JNICALL
Java_ink_wenmo_ime_engine_SimeEngine_nativeSaveUserSentence(
    JNIEnv* env, jclass /*clazz*/, jstring path) {
    if (!g_sime || !g_sime->Ready()) return JNI_FALSE;
    auto p = jstringToString(env, path);
...
JNIEXPORT void JNICALL
Java_ink_wenmo_ime_engine_SimeEngine_nativeSetUserSentenceEnabled(
...
JNIEXPORT void JNICALL
Java_ink_wenmo_ime_engine_SimeEngine_nativeLearnUserSentence(
    JNIEnv* env, jclass /*clazz*/,
